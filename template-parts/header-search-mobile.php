...
<div class="header-search-mobile" data-mobile-search>
	...
	>
		<span class="header-search-mobile__copy">
			...
			<span class="header-search-mobile__hint header-search-mobile__hint--default" data-msm-trigger-hint-default<?php echo $excel_ent_trigger_has_filters ? ' hidden' : ''; ?>><?php esc_html_e( 'By artist, Event Date, budget, date & location', 'excel-ent' ); ?></span>
